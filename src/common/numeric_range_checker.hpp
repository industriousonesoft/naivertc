...
#ifndef _COMMON_NUMERIC_RANGE_CHECKER_H_
#define _COMMON_NUMERIC_RANGE_CHECKER_H_
...
struct RangeCheckImpl<Dst, Src, IsDstSigned, IsSrcSigned, CONTAINS_RANGE> {
    static constexpr RangeCheckResult Check(Src value) { return RangeCheckResult::TYPE_VALID; }
};
...
struct RangeCheckImpl<Dst, Src, DST_UNSIGNED, SRC_UNSIGNED, OVERLAPS_RANGE> {
    static constexpr RangeCheckResult Check(Src value) {
        typedef std::numeric_limits<Dst> DstLimits;
        return BASE_NUMERIC_RANGE_CHECK_RESULT(value <= static_cast<Src>(DstLimits::max()), true);
    }
};
