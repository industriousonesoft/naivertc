...
MY_TEST_F(SpsPpsTrackerTest, SpsPpsOutOfBand) {
    ...
    const std::vector<uint8_t> sps = {0x67, 0x7a, 0x00, 0x0d, 0xbc, 0xd9, 0x41, 0x41, 0xfa, 0x10, 0x00, 0x00,
...
MY_TEST_F(SpsPpsTrackerTest, SpsPpsOutOfBandWrongNaluHeader) {
    ...
    const std::vector<uint8_t> sps = {0xff, 0x7a, 0x00, 0x0d, 0xbc, 0xd9, 0x41, 0x41, 0xfa, 0x10, 0x00, 0x00,
                                      0x03, 0x00, 0x10, 0x00, 0x00, 0x03, 0x03, 0xc0, 0xf1, 0x42, 0x99, 0x60};
