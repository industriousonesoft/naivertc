...
class H264_SpsPpsTrackerTest : public ::testing::Test {
public:
...
TEST_F(H264_SpsPpsTrackerTest, NoNalus) {
    uint8_t data[] = {1, 2, 3};
...
TEST_F(H264_SpsPpsTrackerTest, FuAFirstPacket) {
    uint8_t data[] = {1, 2, 3};
    H264VideoHeader header;
...
TEST_F(H264_SpsPpsTrackerTest, StapAIncorrectSegmentLength) {
...
TEST_F(H264_SpsPpsTrackerTest, SingleNaluInsertStartCode) {
    uint8_t data[] = {1, 2, 3};
    H264VideoHeader header;
    header.h264_header.nalus.resize(1);
...
TEST_F(H264_SpsPpsTrackerTest, NoStartCodeInsertedForSubsequentFuAPacket) {
...
TEST_F(H264_SpsPpsTrackerTest, IdrFirstPacketNoSpsPpsInserted) {
    std::vector<uint8_t> data = {1, 2, 3};
    H264VideoHeader header;
    header.video_header.is_first_packet_in_frame = true;
    AddIdr(header, 0);
...
TEST_F(H264_SpsPpsTrackerTest, IdrFirstPacketNoPpsInserted) {
    std::vector<uint8_t> data = {1, 2, 3};
    H264VideoHeader header;
    header.video_header.is_first_packet_in_frame = true;
...
TEST_F(H264_SpsPpsTrackerTest, IdrFirstPacketNoSpsInserted) {
    std::vector<uint8_t> data = {1, 2, 3};
    H264VideoHeader header;
    header.video_header.is_first_packet_in_frame = true;
...
TEST_F(H264_SpsPpsTrackerTest, SpsPpsPacketThenIdrFirstPacket) {
...
TEST_F(H264_SpsPpsTrackerTest, SpsPpsIdrInStapA) {
    std::vector<uint8_t> data;
    H264VideoHeader header;
    header.h264_header.packetization_type = h264::PacketizationType::STAP_A;
...
TEST_F(H264_SpsPpsTrackerTest, SpsPpsOutOfBand) {
...
TEST_F(H264_SpsPpsTrackerTest, SpsPpsOutOfBandWrongNaluHeader) {
    constexpr uint8_t kData[] = {1, 2, 3};
...
TEST_F(H264_SpsPpsTrackerTest, SpsPpsOutOfBandIncompleteNalu) {
    constexpr uint8_t kData[] = {1, 2, 3};
...
TEST_F(H264_SpsPpsTrackerTest, SaveRestoreWidthHeight) {
    std::vector<uint8_t> data;
