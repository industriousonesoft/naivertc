...
TEST(Base_DivideRoundUpTest, CanBeUsedAsConstexpr) {
    static_assert(DivideRoundUp(5, 1) == 5, "");
    static_assert(DivideRoundUp(5, 2) == 3, "");
}

TEST(Base_DivideRoundUpTest, ReturnsZeroForZeroDividend) {
...
TEST(Base_DivideRoundUpTest, WorksForMaxDividend) {
...
TEST(Base_DivideRoundToNearestTest, CanBeUsedAsConstexpr) {
...
TEST(Base_DivideRoundToNearestTest, DivideByOddNumber) {
...
TEST(Base_DivideRoundToNearestTest, DivideByEvenNumberTieRoundsUp) {
...
TEST(Base_DivideRoundToNearestTest, LargeDivisor) {
    EXPECT_EQ(DivideRoundToNearest(std::numeric_limits<int>::max() - 1,
                                 std::numeric_limits<int>::max()), 1);
}

TEST(Base_DivideRoundToNearestTest, DivideSmallTypeByLargeType) {
    uint8_t small = 0xff;
