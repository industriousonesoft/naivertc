...
#include "rtc/congestion_control/send_side/goog_cc/probe/probe_controller.hpp"
...
public:
    GoogCcNetworkController(const Configuration& config, bool packet_feedback_only);
