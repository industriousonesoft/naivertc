...
void BuildAnOffer() {
    ...
    auto audio = local_sdp.AddAudio("1", sdp::Direction::SEND_RECV);
    audio->AddCodec(111, "OPUS", 48000, 2, "minptime=10;useinbandfec=1");
    auto video = local_sdp.AddVideo("2", sdp::Direction::SEND_RECV);
    video->AddCodec(102, "H264", "profile-level-id=42e01f;packetization-mode=1;level-asymmetry-allowed=1");
